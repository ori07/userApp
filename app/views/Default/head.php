...
<!--     <script src="<?php //echo VIEWS.DFT;?>Js/jquery-3.2.1.js" type="text/javascript"></script>
    <script src="<?php //echo VIEWS.DFT;?>Js/jquery.validate.js" type="text/javascript"></script>
    <script src="<?php //echo VIEWS.DFT;?>Js/validateFunctions.js" type="text/javascript"></script> -->
